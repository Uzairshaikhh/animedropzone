  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-95a96d8e/orders/${order.orderId}/return-request`,
        {
          method: "POST",
          headers: {
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Return Reason */}
              <div>
                <label htmlFor="returnReason" className="block text-white mb-2">
              ...
              {/* Description */}
              <div>
                <label htmlFor="returnDescription" className="block text-white mb-2">
                ...
                <textarea
                  ...
                  required
                />
                <p className="text-gray-400 text-sm mt-1">{description.length}/500 characters</p>
              </div>
