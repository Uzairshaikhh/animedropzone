        ...
        if (data.wallpapers && data.wallpapers.length > 0) {
          const validWallpapers = data.wallpapers
            ...
            .map((w: any) => ({
              ...
              imageUrl: w.imageUrl || w.image_url || w.image, // Handle both camelCase and snake_case
