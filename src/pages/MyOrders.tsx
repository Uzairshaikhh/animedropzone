            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <div>
                      <label htmlFor="orderEmail" className="block text-sm text-gray-300 mb-2 flex items-center gap-2">
                    ...
                    <div>
                      <label htmlFor="orderPhone" className="block text-sm text-gray-300 mb-2 flex items-center gap-2">
